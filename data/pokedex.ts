export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	*/
	...
	agumon: {
		...
		evoLevel: 24,
		evoCondition: "with an Atk stat > its Def stat",
		evos: ["Tyrannomon", "Greymon", "Numemon"],
		eggGroups: ["Monster"],
	},
	greymon: {
		num: -160,
	...
	numemon: {
		...
		weightkg: 150.0,
		color: "Green",
		prevo: "Agumon", // I'm not sure if I can add more than one prevo, tell me if this is a problem
		evoType: "levelHold",
